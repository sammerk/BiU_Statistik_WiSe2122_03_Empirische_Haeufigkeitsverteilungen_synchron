...
Ökolog\*innen untersuchen auf Biscoe Island (Antarktis) `r nrow(penguins_biscoe)` Pinguine. Sie bermessen deren Flügellängen und erhalten die folgenden Lage- und Dispersionsmaße:
...
---
class: hide_logo
```{r, warning=FALSE, out.width="70%", fig.align='center', fig.width=10, retina = 3, fig.height=5}
